...
//Light Mode
val bottomBarColorLight = Color(0xFFE7EAF2) // Soft ve serin bir ton
val bottomBarSelectedItemColorLight = Color(0xFFFC6B3F) // Canlı bir turuncu-kırmızı
val bottomBarUnSelectedItemColorLight = Color(0xFFA3A5A9) // Daha sıcak bir gri
val backgroundColorLight = Color(0xFFFAF9F9) // Krem tonunda beyaz
val bottomBarIndicatorColorLight = Color.Transparent // Şeffaf renk aynı kalır
